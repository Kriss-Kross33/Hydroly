...
import { BarChart3, Droplet, Award, Target, Calendar, TrendingUp } from 'lucide-react-native';
...
export default function StatsScreen() {
  ...
  const { getMonthlyReport, getYearlyReport } = useWater();
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryHeader}>
              ...
              <View>
                ...
                <Text style={styles.summarySubtitle}>Last 7 days performance</Text>
              </View>
            </View>

            <View style={styles.summaryStats}>
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{Math.round(weeklyStats.weekTotal / 1000)}L</Text>
                <Text style={styles.summaryStatLabel}>Total Water</Text>
              </View>
              <View style={styles.summaryDivider} />
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{Math.round(weeklyStats.averageDaily)}ml</Text>
                <Text style={styles.summaryStatLabel}>Daily Average</Text>
              </View>
              <View style={styles.summaryDivider} />
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{weeklyStats.daysCompleted}/7</Text>
                ...
                return (
                  <View key={day.date} style={styles.barContainer}>
                    <View style={styles.barWrapper}>
                      {day.total > 0 && (
                        <Text style={styles.barValue}>{Math.round(day.total / 1000)}L</Text>
                      )}
                      <View style={styles.barTrack}>
                        <View 
                          style={[
                            ...
                            isComplete ? styles.barComplete : styles.barIncomplete,
                          ]} 
                        >
                          {barHeight > maxHeight && (
      ...
      {selectedPeriod === 'month' && features.monthlyReports && (
        <>
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryStats}>
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{Math.round(monthlyReport.totalHydration / 1000)}L</Text>
                <Text style={styles.summaryStatLabel}>Total</Text>
              </View>
              <View style={styles.summaryDivider} />
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{Math.round(monthlyReport.averageDaily)}ml</Text>
                <Text style={styles.summaryStatLabel}>Daily Avg</Text>
              </View>
              <View style={styles.summaryDivider} />
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{monthlyReport.goalsMet}/{monthlyReport.totalDays}</Text>
                <Text style={styles.summaryStatLabel}>Goals Met</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.insightsCard}>
            ...
            <View style={styles.insightRow}>
              ...
              <View style={styles.insightContent}>
                ...
                <Text style={styles.insightValue}>{Math.round(monthlyReport.consistencyScore)}%</Text>
              </View>
            </View>
            ...
            <View style={styles.insightRow}>
              ...
              <View style={styles.insightContent}>
                ...
                <Text style={styles.insightValue}>{monthlyReport.longestStreak} days</Text>
              </View>
            </View>
            ...
            <View style={styles.insightRow}>
              ...
              <View style={styles.insightContent}>
                ...
                <Text style={styles.insightValue}>{Math.round(monthlyReport.bestDay)}ml</Text>
              </View>
            </View>
          </View>
        </>
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryHeader}>
              ...
              <View>
                ...
                <Text style={styles.summarySubtitle}>{currentDate.getFullYear()}</Text>
              </View>
            </View>

            <View style={styles.summaryStats}>
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{Math.round(yearlyReport.totalHydration / 1000)}L</Text>
                <Text style={styles.summaryStatLabel}>Total</Text>
              </View>
              <View style={styles.summaryDivider} />
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{Math.round(yearlyReport.consistencyScore)}%</Text>
                <Text style={styles.summaryStatLabel}>Consistency</Text>
              </View>
              <View style={styles.summaryDivider} />
              <View style={styles.summaryStatItem}>
                <Text style={styles.summaryStatValue}>{yearlyReport.longestStreak}</Text>
          ...
          <View style={styles.insightsCard}>
            ...
            <View style={styles.insightRow}>
              ...
              <View style={styles.insightContent}>
                ...
                <Text style={styles.insightValue}>{yearlyReport.totalDays} days</Text>
              </View>
            </View>
            ...
            <View style={styles.insightRow}>
              ...
              <View style={styles.insightContent}>
                ...
                <Text style={styles.insightValue}>{yearlyReport.goalsMet} days</Text>
              </View>
            </View>
            ...
            <View style={styles.insightRow}>
              ...
              <View style={styles.insightContent}>
                ...
                <Text style={styles.insightValue}>{Math.round(yearlyReport.averageDaily)}ml</Text>
              </View>
            </View>
              ...
              <View style={styles.insightRow}>
                ...
                <View style={styles.insightContent}>
                  ...
                  <Text style={styles.insightValue}>
                    {new Date(yearlyReport.bestMonth + '-01').toLocaleDateString('en-US', { month: 'long' })}
                  </Text>
                </View>
              </View>
            )}
        ...
        <View style={styles.achievementsList}>
          <View style={styles.achievementItem}>
            ...
            <View style={styles.achievementInfo}>
              ...
              <Text style={styles.achievementValue}>{Math.round((weeklyStats.daysCompleted / 7) * 100)}%</Text>
            </View>
          </View>
          ...
          <View style={styles.achievementItem}>
            ...
            <View style={styles.achievementInfo}>
              ...
              <Text style={styles.achievementValue}>{(weeklyStats.weekTotal / 1000).toFixed(1)}L</Text>
            </View>
          </View>
